...
import TeleAStory from "./games/teleAStory/teleAStory.js";
...
const gameData = {
  ...
  teleAStory: {
    title: "Tele-a-Story",
    authors: "Isabela Biramontes, Ashley Diaz, Tanzema Fazal",
    description: "Tel(ephone) a story amoungst friends",
    minUsers: 1,
    maxUsers: 3,
    component: TeleAStory
  }
};
